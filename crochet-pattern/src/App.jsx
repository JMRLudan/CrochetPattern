...
export default function CrochetPatternGenerator() {
  ...
  const generatePattern = useCallback(() => {
    ...
    setPattern(pat);
  }, [image, gridWidth, gridHeight, threshold, invertColors, algorithm, contrast, brightness, edgeSensitivity, adaptiveBlockSize, ditherStrength]);

  useEffect(() => { if (image) generatePattern(); }, [image, generatePattern]);
      ...
      <aside style={{ width: '280px', flexShrink: 0, borderRight: '1px solid #1a1a1a', height: '100%', overflowY: 'auto', backgroundColor: '#0d0d0d' }}>
        ...
        <div style={{ padding: '16px', borderBottom: '1px solid #1a1a1a' }}>
          ...
          >
            ...
            {imagePreview ? (
              <img src={imagePreview} alt="" style={{ maxWidth: '100%', maxHeight: '120px', borderRadius: '4px' }} />
            ) : (
          ...
          {imagePreview && (
            <button onClick={() => { setImage(null); setImagePreview(null); setPattern([]); }} style={{ marginTop: '8px', width: '100%', padding: '6px', background: 'none', border: '1px solid #333', borderRadius: '6px', color: '#888', fontSize: '11px', cursor: 'pointer' }}>
              Remove Image
            </button>
          )}
        </div>
        ...
        <div style={{ padding: '16px', borderBottom: '1px solid #1a1a1a' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '10px', color: '#666' }}>Width: {gridWidth} stitches</label>
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '10px', color: '#666' }}>Height: {gridHeight} stitches</label>
